...
$result = $conn->query($sql);
    ...
    echo"<h2 class='text-center'style='color:white'>รายชื่อโปรโมชั่น</h2>";
...
echo"<table class='table'>";
  echo"<tr>";
   echo" <th class='text-danger'scope='col'>PromotionId</th>";
    echo"<th class='text-danger' scope='col'>PromotionName</th>";
...
if($result-> num_rows>0) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          echo" <tbody>";
          echo"<tr>";
          echo"<th class='text-warning'scope='col'>". $row['PromotionId']."</th>";
          echo" <td class='text-info'>".$row['PromotionName']."</td>";
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="selectpromotion.php"class="active">โปรโมชั่น</a></li>
...
<div class="main-button">
    <a href="insertpromotion.php">เพิ่มข้อมูล</a>
    <a href="selectpromotion1.php">แก้ไข</a>
