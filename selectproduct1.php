...
echo"<thead class='thead-dark'>";
  echo"<tr>";
   ...
   echo" <th scope='col'>ProductId</th>";
    ...
    echo"<th scope='col'>Deleated</th>";
    echo"<th scope='col'>ProductName</th>";
...
<a href="insertproduct.php" class="btn btn-success btn-lg active" role="button" aria-pressed="true">เพิ่ม</a>
